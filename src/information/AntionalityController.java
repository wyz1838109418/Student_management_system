...
public class AntionalityController {
    ...
    private void button() throws ClassNotFoundException, SQLException {
        ...
        String new_antionality = fx_2.getText();
        // 1. 注册驱动
        ...
        String sql = "update Student_management.student set racial=? where sno=?";
        PreparedStatement pst = conn.prepareStatement(sql);
        pst.setString(1,new_antionality);
